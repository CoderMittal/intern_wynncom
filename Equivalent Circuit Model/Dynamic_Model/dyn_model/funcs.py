...
def minfn(data, model, theTemp, doHyst):
    ...
    v1 = OCVfromSOCtemp(0.9, data[ind].temp, model)[0]
    v2 = OCVfromSOCtemp(0.1, data[ind].temp, model)[0]
...
def processDynamic(data, modelocv, numpoles, doHyst):
    ...
    ind1_1 = np.where(data[k].s1.step == 1)[0]
    ind1_2 = np.where(data[k].s1.step == 2)[0]
    ind1_3 = np.where(data[k].s1.step == 3)[0]
    ind1_4 = np.where(data[k].s1.step == 4)[0]

    ind2_1 = np.where(data[k].s2.step == 1)[0]
    ind2_2 = np.where(data[k].s2.step == 2)[0]
    ind2_3 = np.where(data[k].s2.step == 3)[0]

    ind3_1 = np.where(data[k].s3.step == 1)[0]
    ind3_2 = np.where(data[k].s3.step == 2)[0]
    ind3_3 = np.where(data[k].s3.step == 3)[0]

    # print(data[k].s2.disAh[ind2_2[-1]], " ", data[k].s2.chgAh[ind2_2[-1]])
    # print(data[k].s2.disAh[ind2_3[-1]], " ", data[k].s2.chgAh[ind2_3[-1]])
    # input()
    # print(data[k].s1.disAh[ind1_2[-1]]+data[k].s1.disAh[ind1_3[-1]])
    # input()
    totDisAh = (data[k].s1.disAh[ind1_1[-1]]+data[k].s1.disAh[ind1_2[-1]]+data[k].s1.disAh[ind1_3[-1]]+data[k].s1.disAh[ind1_4[-1]]) + (data[k].s2.disAh[ind2_1[-1]]+data[k].s2.disAh[ind2_2[-1]]+data[k].s2.disAh[ind2_3[-1]]) + (data[k].s3.disAh[ind3_1[-1]]+data[k].s3.disAh[ind3_2[-1]]+data[k].s3.disAh[ind3_3[-1]])
    totChgAh = (data[k].s1.chgAh[ind1_1[-1]]+data[k].s1.chgAh[ind1_2[-1]]+data[k].s1.chgAh[ind1_3[-1]]+data[k].s1.chgAh[ind1_4[-1]]) + (data[k].s2.chgAh[ind2_1[-1]]+data[k].s2.chgAh[ind2_2[-1]]+data[k].s2.chgAh[ind2_3[-1]]) + (data[k].s3.chgAh[ind3_1[-1]]+data[k].s3.chgAh[ind3_2[-1]]+data[k].s3.chgAh[ind3_3[-1]])
    ...
    Q25 = (data[k].s1.disAh[ind1_2[-1]]+data[k].s1.disAh[ind1_3[-1]]) + (data[k].s2.disAh[ind2_2[-1]]+data[k].s2.disAh[ind2_3[-1]]) - (data[k].s1.chgAh[ind1_2[-1]]+data[k].s1.chgAh[ind1_3[-1]]) - (data[k].s2.chgAh[ind2_2[-1]]+data[k].s2.chgAh[ind2_3[-1]])
    data[k].Q = Q25
    allQs[k] = Q25

    eta25 = np.mean(alletas[ind25])
    # print("totDisAh", totDisAh)
    # print("totChgAh", totChgAh)
    print("Q", Q25)
    # print("eta", eta25)
    input()
    ...
    for k in not25:
        ...
        data[k].s2.chgAh = data[k].s2.chgAh*eta25
        data[k].s3.chgAh = data[k].s3.chgAh*eta25
        eta = ((data[k].s1.disAh[ind1_1[-1]]+data[k].s1.disAh[ind1_2[-1]]+data[k].s1.disAh[ind1_3[-1]]+data[k].s1.disAh[ind1_4[-1]]) + (data[k].s2.disAh[ind2_1[-1]]+data[k].s2.disAh[ind2_2[-1]]+data[k].s2.disAh[ind2_3[-1]]) + (data[k].s3.disAh[ind3_1[-1]]+data[k].s3.disAh[ind3_2[-1]]+data[k].s3.disAh[ind3_3[-1]]) - (data[k].s2.chgAh[ind2_1[-1]]+data[k].s2.chgAh[ind2_2[-1]]+data[k].s2.chgAh[ind2_3[-1]]) - (data[k].s3.chgAh[ind3_1[-1]]+data[k].s3.chgAh[ind3_2[-1]]+data[k].s3.chgAh[ind3_3[-1]]))/(data[k].s1.chgAh[ind1_1[-1]]+data[k].s1.chgAh[ind1_2[-1]]+data[k].s1.chgAh[ind1_3[-1]]+data[k].s1.chgAh[ind1_4[-1]])

        data[k].s1.chgAh = eta*data[k].s1.chgAh
        data[k].eta = eta
        alletas[k] = eta

        Q = (data[k].s1.disAh[ind1_1[-1]]+data[k].s1.disAh[ind1_2[-1]]+data[k].s1.disAh[ind1_3[-1]]+data[k].s1.disAh[ind1_4[-1]]) + (data[k].s2.disAh[ind2_1[-1]]+data[k].s2.disAh[ind2_2[-1]]+data[k].s2.disAh[ind2_3[-1]]) - (data[k].s1.chgAh[ind1_1[-1]]+data[k].s1.chgAh[ind1_2[-1]]+data[k].s1.chgAh[ind1_3[-1]]+data[k].s1.chgAh[ind1_4[-1]]) - (data[k].s2.chgAh[ind2_1[-1]]+data[k].s2.chgAh[ind2_2[-1]]+data[k].s2.chgAh[ind2_3[-1]])
        data[k].Q = Q
        allQs[k] = Q
