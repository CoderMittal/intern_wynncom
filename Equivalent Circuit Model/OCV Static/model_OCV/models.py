...
class BatteryScript:
    ...
    def __init__(self, csvdata):
        ...
        df = pd.read_excel(csvdata, usecols=columns)
...
class BatteryData:
    ...
    def __init__(self, xlfiles):
        """
        Initialize with list of Excel data files.
        """
        self.s1 = BatteryScript(xlfiles[0])
        self.s2 = BatteryScript(xlfiles[1])
        self.s3 = BatteryScript(xlfiles[2])
        self.s4 = BatteryScript(xlfiles[3])
